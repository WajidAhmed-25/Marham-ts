        ...
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
          ...
          <div className="flex space-x-6  md:order-2 max-fourthsmall::bg-red-800">
            ...
            <div className="dropdown dropdown-hover">
              <label className="btn px-5 bgb py-4 max-md3:px-5 max-sm:px-3 max-sm:py-1 max-sixthsmall:px-1 max-sixthsmall:py-1 max-fifthsmall:px-1 max-fifthsmall:py-1 max-triplesmall:px-1 max-triplesmall:pyS-1 max-fourthsmall:py-1  font-semibold text-gray-100 bg-white rounded-md border-2 border-black  " tabIndex={0}> <FontAwesomeIcon icon={faUserDoctor} className='text-black' size="lg" />    <FontAwesomeIcon className='ml-4 mt-1 text-black' icon="angle-down" size="lg" /></label>
              <div className="dropdown-menu dropdown-menu-bottom-right mt-2 w-28 bg-white border-2 border-gray-400  ">
